...
export default function Home() {
  ...
  />
    ...
    <divclassName= className="input-group mb-3">
  <div className="input-group-text">
    <input className="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input" />
  </div>
  <input
    type="text"
    className="form-control border border-gray-800 p-2 m-6"
    ...
    aria-label="Text input with checkbox"
  />
</divclassName="d-flex justify-content-center" >

               
        
        <button  
        
          class=' rounded btn btn-success justify-content-center '
          type="submit"
